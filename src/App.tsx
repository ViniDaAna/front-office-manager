...
export default function App() {
  const [state, setState] =
    useState<GameState | null>(() => loadGame())
    ...
    return (
      <main className="setup-shell">
        <section className="setup-card">
          ...
          <h1>
            Sua carreira começa no escritório.
          </h1>

          <p className="muted">
            Informação → decisão → continuar →
            consequência.
          </p>
          ...
          <p className="tiny-note">
            Primeiro estamos construindo o coração
            da carreira. Elencos, contratos, staff,
            scouting e expansão crescerão em cima
            desta fundação.
          </p>
        </section>
      </main>
        ...
        {activeSection === 'Inbox' ? (
          <div className="inbox-layout">
            ...
            <aside className="context-panel">
              ...
              <p>
                Suas escolhas serão
                registradas na carreira e
                poderão ser usadas para
                avaliar seu trabalho no
                futuro.
              </p>
          ...
          <section className="placeholder-panel">
            ...
            <p>
              ...
              quando seu sistema entrar no
              roadmap da versão jogável.
            </p>
          </section>
        )}
      </section>
