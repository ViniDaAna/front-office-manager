...
function createDailyEvents(
  ...
  if (day === 1) {
    ...
    messages.push({
      id:
        `owner-expectations-${date}`,
      date,
      category: 'Owner',
      title:
        'O proprietário quer definir as expectativas',
      body:
  ...
  if (day === 2) {
    messages.push({
      id:
        `scouting-meeting-${date}`,
      date,
      category: 'Scouting',
      title:
        'Primeira reunião do departamento de scouting',
      body:
  ...
  if (day === 3) {
    messages.push({
      ...
      category: 'Staff',
      title:
        'O treinador quer conversar sobre o elenco',
      body:
  ...
  if (day === 4) {
    messages.push({
      ...
      category: 'Trade',
      title:
        'Uma franquia demonstrou interesse em conversar',
      body:
  ...
  if (day === 5) {
    messages.push({
      ...
      category: 'League',
      title:
        'Movimentações começam a acontecer pela liga',
      body:
  ...
  if (day === 7) {
    messages.push({
      ...
      category: 'Medical',
      title:
        'Departamento médico entrega relatório inicial',
      body:
